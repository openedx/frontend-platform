...
```json
{
    "core": {
        ...
        "variants": {
            ...
            "dark": {
                "urls": {
                    "default": "https://cdn.jsdelivr.net/npm/@openedx/paragon@$paragonVersion/dark/light.min.css",
                    "brandOverride": "https://cdn.jsdelivr.net/npm/@openedx/brand-openedx-edx.org@$brandVersion/dist/dark.min.css",
                },
            },
