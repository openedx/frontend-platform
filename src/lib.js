 ...
 *
 * The first parameter is an object containing messages for each supported locale,
 * indexed by locale name. The second is the application configuration object.
 *
